...
void Stage1MainProcess()
{
    ...
    else
    {
        ...
        if (!isPause)
        {
            ...
            {
                textPositionSet(70, 1920, "ñ⁄ïW:çUåÇÇîÇØÇƒê∂Ç´écÇÍ", japaneseFontHandle, SORT_LEFT, 60, true, GetColor(0, 255, 0), GetColor(50, 50, 50));
            ...
            {
                textPositionSet(70, 1920, "ñ⁄ïW:ìGã@ÇåÇíƒÇµÇÎ", japaneseFontHandle, SORT_LEFT, 60, true, GetColor(0, 255, 0), GetColor(50, 50, 50));
